<?php
/**
 * Template Name: Recurring Donation Features Layout
 * CharityGlow recurring donations feature page: monthly/annual, donor management, Free vs Pro.
 *
 * @package Techsome
 */
...
$config = techsome_get_feature_config( 'recurring-donation' );
if ( ! $config ) {

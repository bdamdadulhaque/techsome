<?php
/**
 * Template Name: Campaign Features Layout
 * CharityGlow campaign feature page: goals, deadlines, progress bars, Free vs Pro.
 *
 * @package Techsome
 */
...
$config = techsome_get_feature_config( 'campaign' );
if ( ! $config ) {

<?php
/**
 * Extended footer: above-footer CTA + columns + bottom.
 *
 * @package Techsome
 */
...
$has_above = is_active_sidebar( 'above-footer' );
$has_columns = is_active_sidebar( 'footer-1' ) || is_active_sidebar( 'footer-2' ) || is_active_sidebar( 'footer-3' ) || is_active_sidebar( 'footer-4' );
?>
<footer class="techsome-footer techsome-footer--extended" role="contentinfo">
	<?php if ( $has_above ) : ?>
		<div class="techsome-footer__cta">
			<div class="techsome-container"><?php dynamic_sidebar( 'above-footer' ); ?></div>
		</div>
	<?php endif; ?>

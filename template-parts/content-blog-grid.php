...
?>
<?php if ( have_posts() ) : ?>
	<div class="techsome-posts techsome-posts--grid">
		<?php while ( have_posts() ) : the_post(); ?>
			<article id="post-<?php the_ID(); ?>" <?php post_class( 'techsome-card techsome-card--grid' ); ?>>
				...
				<div class="techsome-card__body">
					...
					<div class="techsome-card__excerpt techsome-prose"><?php echo wp_trim_words( get_the_excerpt(), 20 ); ?></div>

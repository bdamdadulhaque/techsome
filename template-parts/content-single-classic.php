...
<?php while ( have_posts() ) : the_post(); ?>
	<article id="post-<?php the_ID(); ?>" <?php post_class( 'techsome-single techsome-single--classic' ); ?>>
		<header class="techsome-single__header">
			...
			<?php if ( has_post_thumbnail() ) : ?>
				<div class="techsome-single__thumb"><?php the_post_thumbnail( 'large', array( 'alt' => get_the_title() ) ); ?></div>
			<?php endif; ?>
		</header>
